...
/* BB variables. */
#define MENDER_STORAGE_DEVICE "tssdcard"
#define MENDER_STORAGE_DEVICE_BASE "tssdcarda"
#define MENDER_UBOOT_ENV_STORAGE_DEVICE_OFFSET_1 0x400000
#define MENDER_UBOOT_ENV_STORAGE_DEVICE_OFFSET_2 0x600000
#define MENDER_ROOTFS_PART_A_NAME "/dev/tssdcarda2"
#define MENDER_ROOTFS_PART_B_NAME "/dev/tssdcarda3"
/* For sanity checks. */
#define MENDER_BOOTENV_SIZE 0x20000
#define MENDER_BOOT_KERNEL_TYPE "bootz"
#define MENDER_KERNEL_NAME "zImage"
#define MENDER_DTB_NAME "armada-385-ts7800-v2.dtb"
